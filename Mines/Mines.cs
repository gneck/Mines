            ...
            if ((e.Button == MouseButtons.Left) && (minebutton.Text != "?"))
            {
                ...
                else
                {
                    ...
                    if (this.checkVictory())
                    {
                        ...
                        if (MessageBox.Show("Vyhrál jsi v čase: " + _form.time + "s!\nMáš jedinečné schopnosti hledače min.\n\nPřeješ si započít další hledání?", "Výhra", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
                        {
                            Application.Restart();
                        }
                        else
